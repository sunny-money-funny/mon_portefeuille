    ...
    <>
      ...
      <main className={styles.container}>
        ...
        <section id="about" className={styles.about}>
          <h2>About Me</h2>
          <p>
            서강대학교 사회학과와 융합소프트웨어를 복수전공하며 {""}
            <strong>사람에 대한 이해와 기술적 구현</strong>을 함께 탐구하고
            있습니다.
          </p>
          <p>
            학문적으로는 사회 현상을 분석하며 사람들의 행동과 맥락을 이해했고,
            기술적으로는 React와 TypeScript를 활용한 프로젝트를 통해 이를 서비스
            UI/UX 설계와 프론트엔드 개발로 연결해왔습니다.
          </p>
          <p>
            특히 AI와 UX 리서치를 접목한 웹서비스에 관심이 많으며, 사람 중심의
            디지털 경험을 만들어가는 것을 목표로 합니다.
          </p>
        </section>
        ...
        <section id="skills" className={styles.skills}>
          ...
          <div className={styles.skillsList}>
            <div className={styles.skillItem}>
              <Image src={reactimg} alt="React logo" width={40} height={40} />
              <span>React</span>
            </div>
            <div className={styles.skillItem}>
              <Image src={tsimg} alt="TypeScript logo" width={40} height={40} />
              <span>TypeScript</span>
            </div>
          </div>
          <div className={styles.skillNote}>
            <p>Familiar with: Java, Python, React Native</p>
          </div>
        </section>
